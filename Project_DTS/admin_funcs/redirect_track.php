...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="../admin/HomePageAdmin.php"><span class="las la-home"></span>
                ...
                <li>
                    <a href="../admin/office_docs.php"><span class="las la-file-alt"></span>
                    <span>Office Documents</span></a>
                </li>
                <li>
                    <a href="../admin/pending_docs.php"><span class="las la-arrow-circle-up"></span>
                    <span>Pending For Release</span></a>
                </li>
                <li>
                    <a href="../admin/received_docs.php"><span class="las la-arrow-circle-down"></span>
                    <span>Received</span></a>
                </li>
                <li>
                    <a href="../admin/released_docs.php"><span class="las la-chevron-circle-up"></span>
                    <span>Released</span></a>
                </li>   
                <li>
                    <a href="../admin/terminal_docs.php"><span class="las la-check-circle"></span>
    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-wrapper">
                ...
                <div>
                    <h5><?php echo $_SESSION["a_username"]; ?>(<?php echo $_SESSION["a_officeName"]; ?>)</h5>
                    <small>Admin</small>
                </div>
            </div>
        </header>
