...
<head>
    ...
    <title>Terminal Documents</title>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a class="active"><span class="las la-check-circle"></span>
                    ...
                    <table id="data_table" class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                                ...
                                $db = $database->open();
                                try{	
                                    $sql = "SELECT documents.trackingID, documents.title, documents.type, documents.reason, documents.remarks, documents.status, logs.terminal_at 
                                    FROM documents 
                                    INNER JOIN logs ON logs.trackingID = documents.trackingID INNER JOIN users ON users.id = logs.user_id 
                                    WHERE logs.terminal_at != 'none' AND logs.office = '".$_SESSION['a_officeName']."';";
                                    $no=0;
