...
try{	
    ...
    WHERE documents.trackingID = '".$_POST['termTrackingID']."' ORDER BY logs.id DESC LIMIT 1;";
    ...
    <nav class="navbar navbar-expand-sm navbar-dark border-bottom border-dark" style="background-color:#8e0413;">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link fw-bold" href="../clerk/HomePageC.php">Home</a>
              </li> 
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active fw-bold" aria-current="page">Tag As Terminal</a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link fw-bold text-white"><?php echo $_POST['termTrackingID'];?></a>
              </li>
          ...
          <div class="container">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-hover">
                <thead>
                  <tr>
                      <th class="text-center fs-4" colspan="2">OVERVIEW OF <?php echo $_POST['termTrackingID'];?></th>
                    </tr>
                </thead>
            ...
            <form action="../clerk_funcs/terminal.php"  id="mainSec" method="POST">
              <br>
              <br>
              <input type="text" name="termTrackingID"  value="<?php echo $_POST['termTrackingID'];?>" hidden>

              <input type="text" class="form-control" name="status" value="terminal" hidden>
            ...
            <div class="d-flex justify-content-center">
                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                  ...
                  <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#terminalModal">Yes</button>
                </div>
              </div>
          </div>
      <br>
      ...
      <!-- Modal for terminal document-->
      <div class="modal fade" id="terminalModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"  aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="finalModalLabel">Terminal Document</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
              <p>Do you wish to tag this document as termnial? Doing so indicates that your office is the last stop for this document.</p>
            </div>
