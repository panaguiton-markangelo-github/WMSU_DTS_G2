<?php
	...
	if(isset($_POST['submit'])){
		...
		$db = $database->open();
		if($_POST['active'] == 'yes'){
			$message = "Admin user was activated successfully!";
		}
		elseif($_POST['active'] == 'no'){
			$message = "Admin user was deactivated successfully!";
		}
		...
		try{
			...
			if ($error_m1 == 23000) {
				...
				header("Location: ../super_admin/admin_users.php?error=exist");
				exit();
			}
		}
	...
	header('location: ../super_admin/admin_users.php?succesful?');
