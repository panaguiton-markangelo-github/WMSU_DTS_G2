...
if(isset($_POST['request_arc'])){
    ...
    if($request_arc == "none"){
        $query = "SELECT DISTINCT documents.*, yearsemester.schoolYear, users.officeName FROM documents 
        INNER JOIN yearsemester ON yearsemester.id = documents.yearSemID 
        INNER JOIN users ON users.id = documents.user_id WHERE yearsemester.activated = 'no' AND users.officeName = '".$_SESSION['c_officeName']."'
        ORDER BY documents.id DESC;";
        $result = mysqli_query($data, $query);
        $count = mysqli_num_rows($result);
    }
        ...
        $query = "SELECT DISTINCT documents.*, yearsemester.schoolYear, users.officeName FROM documents 
        INNER JOIN yearsemester ON yearsemester.id = documents.yearSemID 
        INNER JOIN users ON users.id = documents.user_id WHERE documents.type = '$request_arc' AND yearsemester.activated = 'no' AND users.officeName = '".$_SESSION['c_officeName']."'
        ORDER BY documents.id DESC;";
        $result = mysqli_query($data, $query);
        $count = mysqli_num_rows($result);     
    }
...
if(isset($_POST['request_arc_year'])){
    ...
    if($request_arc_year == "none"){
        ...
        $query = "SELECT DISTINCT documents.*, yearsemester.schoolYear, users.officeName FROM documents 
        INNER JOIN yearsemester ON yearsemester.id = documents.yearSemID 
        INNER JOIN users ON users.id = documents.user_id WHERE documents.schoolYear = '$request_arc_year' AND yearsemester.activated = 'no' AND users.officeName = '".$_SESSION['c_officeName']."'
        ORDER BY documents.id DESC;";
        $result = mysqli_query($data, $query);
        $count = mysqli_num_rows($result);     
    }
