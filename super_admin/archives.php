                   ...
                   <div class="col-2">
                        <select id="s_type" class="form-select">
                            ...
                            <?php
                                ...
                                $db = $database->open();
                                try{	
                                    $sql = "SELECT DISTINCT type FROM documents INNER JOIN yearsemester ON documents.yearSemID = yearsemester.id WHERE yearsemester.activated = 'no';";
                   ...
                   <div class="col-3">
                        <select id="s_school_year" class="form-select">
                            ...
                            <?php
                                ...
                                $db = $database->open();
                                try{	
                                    $sql = "SELECT DISTINCT documents.schoolYear FROM documents INNER JOIN yearsemester ON yearsemester.id = documents.yearSemID WHERE yearsemester.activated = 'no';";
