                   ...
                   <div class="col-2">
                        <select id="s_type" class="form-select">
                            ...
                            <?php
                                ...
                                $db = $database->open();
                                try{	
                                    $sql = "SELECT DISTINCT type FROM documents INNER JOIN users ON users.id = documents.user_id INNER JOIN yearsemester ON yearsemester.id = documents.yearSemID WHERE yearsemester.activated = 'no' AND users.officeName = '".$_SESSION['a_officeName']."';";
                   ...
                   <div class="col-3">
                        <select id="s_school_year" class="form-select">
                            ...
                            <?php
                                ...
                                $db = $database->open();
                                try{	
                                    $sql = "SELECT DISTINCT documents.schoolYear FROM documents INNER JOIN users ON users.id = documents.user_id INNER JOIN yearsemester ON yearsemester.id = documents.yearSemID WHERE yearsemester.activated = 'no' AND users.officeName = '".$_SESSION['a_officeName']."';";
                        ...
                        <tbody>
                             <?php
                                ...
                                try{	
                                    ...
                                    WHERE users.officeName = '".$_SESSION['a_officeName']."' AND yearsemester.activated = 'no'
